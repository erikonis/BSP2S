...
META_JSON_DIR = (
    "Java_20perEx_codes_hum_raw/metadata.json"  #   # Path to metadata JSON file
)
OUTPUT_DIR = "data_preproc_sheetSplit"  # Output directory for images and info
HUMAN_DIR = "Java_20perEx_codes_hum_preproc"  # Directory containing human code files
...
def create_readme(directory):
    """
    Create a readme.txt file in the given directory describing label meanings.
    """
...
def organize_images(
    ...
    # Each item: [img_name, image, image_origin, image_quality, directory]
    label_files["0"] = [
